          ...
          <section className="mt-5 flex flex-col gap-3">
            ...
            <ModalEliminarCuenta
              ...
              trigger={
                <button
                  type="button"
                  className="w-full rounded-md border border-gray-300 bg-white px-3 py-2 shadow-sm flex items-center gap-3 hover:border-red-300 focus:outline-none focus:ring focus:ring-red-200 cursor-pointer"
                >
