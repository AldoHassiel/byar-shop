...
export default function MisFavoritos() {
  const { productosFavoritos, cargandoProductosFavoritos, eliminarFavorito } =
    useFavoritos();
  ...
  const productosPaginados = productosFavoritos.slice(indiceInicio, indiceFin);
  ...
  return (
    <>
      ...
      {productosPaginados.length === 0 && !cargandoProductosFavoritos && (
        <ModuloVacio modulo="favoritos" />
      )}
